...
| [markbang/cohub-pr-skill](https://github.com/markbang/cohub-pr-skill) | `pr-workflow` — 基于 git worktree 的并行 PR 开发 + 每个 PR 独立 Session |
| [kjx-talesofai/claude-skill-rtb-advisor](https://github.com/kjx-talesofai/claude-skill-rtb-advisor) | `rtb-advisor` — 品牌策略 "Reason to Believe" 质询 |
