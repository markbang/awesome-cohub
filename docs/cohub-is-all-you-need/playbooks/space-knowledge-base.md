...
# Build a compounding wiki in a Space

## When

Multiple people/agents must share evolving understanding — not re-paste history every Chat.
...
[中文](../zh/playbooks/space-knowledge-base.md)
