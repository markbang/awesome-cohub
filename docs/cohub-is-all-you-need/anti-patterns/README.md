...
| ID | Title | File |
|----|-------|------|
| `cohub.ap.auth-on-load` | Auth on page load | [auth-on-load.md](./auth-on-load.md) |
| `cohub.ap.bake-live-data-dist` | Baking live data into dist | [bake-live-data-dist.md](./bake-live-data-dist.md) |
| `cohub.ap.browser-router-static` | BrowserRouter on static Apps | [browser-router-static.md](./browser-router-static.md) |
| `cohub.ap.chat-only-project` | Chat-only project | [chat-only-project.md](./chat-only-project.md) |
| `cohub.ap.commerce-on-static-preview` | Testing App commerce on static preview | [commerce-on-static-preview.md](./commerce-on-static-preview.md) |
...
| `cohub.ap.rebuild-auth-in-work` | Rebuilding Cohub auth inside an App | [rebuild-auth-in-work.md](./rebuild-auth-in-work.md) |
| `cohub.ap.skill-assets-at-repo-root` | Skill assets at repo root | [skill-assets-at-repo-root.md](./skill-assets-at-repo-root.md) |
| `cohub.ap.static-work-as-api` | Static App as API backend | [static-work-as-api.md](./static-work-as-api.md) |
