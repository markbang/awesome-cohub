...
A **Space** is the main creative surface in Cohub: Chats, files, Saves, Works, tasks, members, channels, and settings in one isolated environment.
...
- Workspace Markdown can resolve relative image/video/audio assets; keep those files in the Space
